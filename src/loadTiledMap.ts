...
export default async function(url: string): Promise<object> {
  ...
  console.log('(-1,-3)->(4,6)', tiledMap.layers.get('Kachelebene 1').getGlobalTileIdsAt(-1, -3, 4, 6));
  console.log('(10,0)->(2,2)', tiledMap.layers.get('Kachelebene 1').getGlobalTileIdsAt(10, 0, 2, 2));
  return tiledMap;
}
